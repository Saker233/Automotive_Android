...
#define DRIVER_NAME "SakerDriver"
#define DRIVER_CLASS "Saker_class"

MODULE_LICENSE("GPL");
MODULE_AUTHOR("Mohamed Saker");
MODULE_DESCRIPTION("Hello from Saker");
...
static int __init sakerINIT(void)
{
    printk("HELLO from Saker\n");
...
static void __exit sakerDEINIT(void)
{
